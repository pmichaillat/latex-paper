...
The references from the main text (in the \texttt{paper.tex} file) are available in the online appendix as long as the appendix is compiled after the main text and the auxiliary LaTeX file \texttt{paper.aux} is available. Here are some references to the main text: equation \ref{e:type1} was very helpful; figure \ref{f:graph1} provided a lot of information---especially the plot on figure \ref{f:panel2}; section \ref{s:graphs} presented new results, and so did section \ref{s:lists}. Table~\ref{t:table1} contained interesting information.

...
- [Beveridgean Phillips Curve](https://arxiv.org/pdf/2401.12475v3.pdf) (by P. Michaillat and E. Saez)
- [Modeling Migration-Induced Unemployment](https://arxiv.org/pdf/2303.13319v6.pdf) (by P. Michaillat)
- [Has the Recession Started?](https://arxiv.org/pdf/2408.05856v2.pdf) (by P. Michaillat and E. Saez)
- [Critical Values Robust to P-hacking](https://arxiv.org/pdf/2005.04141v7.pdf) (by A. McCloskey and P. Michaillat)
- [Market Beliefs about Open vs. Closed AI](https://arxiv.org/pdf/2512.14969v3.pdf) (by D. Bjorkegren)
- [External and Internal Market for Managers](https://gstoledo.github.io/docs/Toledo_JMP.pdf) (by G. Toledo)
- [Workers as Partners: a Theory of Responsible Firms in Labor Markets](https://arxiv.org/pdf/2411.05567v4.pdf) (by F. Del Prato and M. Fleurbaey)
- [Comparing Experimental and Nonexperimental Methods: What Lessons Have We Learned Four Decades After LaLonde (1986)?](https://arxiv.org/pdf/2406.00827v1.pdf) (by G. Imbens and Y. Xu)
- [Identification of Average Treatment Effects in Nonparametric Panel Models](https://arxiv.org/pdf/2503.19873v1.pdf) (by S. Athey and G. Imbens)
- [Triply Robust Panel Estimators](https://arxiv.org/pdf/2508.21536v3.pdf) (by S. Athey, G. Imbens, Z. Qu, and D. Viviano)
- [Estimating Variances for Causal Panel Data Estimators](https://arxiv.org/pdf/2510.11841v2.pdf) (by A. Almeida, S. Athey, G. Imbens, E. Lestant, and A. Olaizola)
- [Estimating Causal Effects from Data Generated by Stochastic Algorithms](https://arxiv.org/pdf/2607.05792v1.pdf) (by S. Athey, G. Imbens, and Z. Ji)
- [The Labor Market Incidence of New Technologies](https://arxiv.org/pdf/2504.04047v2.pdf) (by T. Fan)
- [Measuring Geopolitical Alignment and Economic Growth](https://arxiv.org/pdf/2507.04833v6) (by T. Fan)
- [MarketBench: Evaluating AI Agents as Market Participants](https://arxiv.org/pdf/2604.23897v1.pdf) (by A. Fradkin and R. Krishnan)
- [Automation Experiments and Inequality](https://arxiv.org/pdf/2510.24923v1.pdf) (by S. Benzell and K. Myers)
- [Productivity Beliefs and Efficiency in Science](https://arxiv.org/pdf/2510.24916v1.pdf) (by F. Bertolotti, K. Myers, and W. Y. Tham)
- [Green Shields: The Role of ESG in Uncertain Time](https://arxiv.org/pdf/2506.02143v1.pdf) (by F. Kansoy and D. Stasiulaitis)
- [The Empirical Content of Revealed Preference in High Dimensions](https://arxiv.org/pdf/2605.29361v1.pdf) (by I. Crawford and L. Tian)
- [Beveridgean Unemployment Gap with Part-time Employment](https://arxiv.org/pdf/2606.21801) (by R. Zhang)
- [Recession Detection in Japan using Labor Market Data](https://arxiv.org/pdf/2606.00948) (by N. Sikand and R. Zhang)

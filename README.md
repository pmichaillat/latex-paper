...
+ [latex-book](https://github.com/pmichaillat/latex-book) - This LaTeX template produces academic books following the same typographic principles and with a similar appearance as this paper template. 
